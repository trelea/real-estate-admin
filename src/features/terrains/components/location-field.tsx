// Copied from src/features/apartments/components/location-field.tsx
// Used for house forms
          ...
          <FormItem className="w-full">
            ...
            <Popover>
                ...
                <FormControl>
                  ...
                  >
                    {field.value
                      ...
                      : t("createTerrain.select_category")}
              ...
              <PopoverContent>
                <Command>
                  <CommandInput
                    placeholder={t("createTerrain.search_category")}
                  />
                  <CommandList>
                    <CommandEmpty>
                      {t("createTerrain.no_category_found")}
                    </CommandEmpty>
                    <CommandGroup>
          ...
          <FormItem>
            ...
            <Popover>
                ...
                <FormControl>
                  ...
                  >
                    {field.value
                      ...
                      : t("createTerrain.select_subcategory")}
                    <ChevronsUpDown className="opacity-50" />
                  </Button>
                </FormControl>
              </PopoverTrigger>
              <PopoverContent>
                <Command>
                  <CommandInput
                    placeholder={t("createTerrain.search_subcategory")}
                  />
                  <CommandList>
                    <CommandEmpty>
                      {t("createTerrain.no_subcategory_found")}
                    </CommandEmpty>
                    <CommandGroup>
