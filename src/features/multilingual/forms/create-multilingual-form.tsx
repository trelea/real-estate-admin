...
import { z } from "zod";
import { createMultilingualSchema } from "../validation";

interface Props {
  form: UseFormReturn<LanguagesFieldsType<{}>>;
  onSubmit: (
    _: z.infer<typeof createMultilingualSchema>
...
export const CreateMultilingualForm: React.FC<Props> = ({
  form,
  onSubmit,
  isLoading,
  fields,
