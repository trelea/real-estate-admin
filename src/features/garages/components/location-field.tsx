          ...
          <FormItem className="w-full">
            ...
            <Popover>
                ...
                <FormControl>
                  ...
                  >
                    {field.value
                      ...
                      : t("createGarage.select_category")}
              ...
              <PopoverContent>
                <Command>
                  <CommandInput
                    placeholder={t("createGarage.search_category")}
                  />
                  <CommandList>
                    <CommandEmpty>
                      {t("createGarage.no_category_found")}
                    </CommandEmpty>
                    <CommandGroup>
          ...
          <FormItem>
            ...
            <Popover>
                ...
                <FormControl>
                  ...
                  >
                    {field.value
                      ...
                      : t("createGarage.select_subcategory")}
                    <ChevronsUpDown className="opacity-50" />
                  </Button>
                </FormControl>
              </PopoverTrigger>
              <PopoverContent>
                <Command>
                  <CommandInput
                    placeholder={t("createGarage.search_subcategory")}
                  />
                  <CommandList>
                    <CommandEmpty>
                      {t("createGarage.no_subcategory_found")}
                    </CommandEmpty>
                    <CommandGroup>
