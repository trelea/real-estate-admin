...
export const GarageFeaturesField: React.FC<Props> = ({
  control,
  name,
  label,
  ...
  const { data } = useGetGarageFeaturesQuery(params, {
        ...
        <FormItem>
          ...
          <Popover>
                  ...
                  {field.value?.length
                    ? // @ts-ignore
                      (
                        ...
                        ?.slice(0, 25)
                        ?.concat("...")
                    : t("createGarage.select_features")}
            ...
            <PopoverContent className="w-[300px] max-h-96 overflow-auto">
              <Command>
                <CommandInput
                  placeholder={t("createGarage.search_features")}
                />
                <CommandList>
                  <CommandEmpty>
                    {t("createGarage.no_features_found")}
                  </CommandEmpty>
                  <CommandGroup>
